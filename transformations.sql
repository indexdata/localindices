...
delete from step where ID = 10;
insert into step (ID, DTYPE, NAME, ENABLED, SCRIPT) values ( 10, 'BasicTransformationStep', 'OAIPMH-DC to PZ', 1, '<?xml version="1.0" encoding="UTF-8"?>
<!--
...
delete from step where ID = 20;
insert into step (ID, DTYPE, NAME, ENABLED, SCRIPT) values ( 20, 'BasicTransformationStep', 'OAIPMH-MARC to MARC21', 1, '<?xml version="1.0" encoding="UTF-8"?>
<!--
...
delete from step where ID = 22;
insert into step (ID, DTYPE, NAME, ENABLED, SCRIPT) values ( 22, 'BasicTransformationStep', 'MARC21 to PZ', 1, '<?xml version="1.0" encoding="UTF-8"?>
<xsl:stylesheet
    version="1.0"
    xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    xmlns:pz="http://www.indexdata.com/pazpar2/1.0"
