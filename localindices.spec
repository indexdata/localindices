...
%package -n masterkey-harvester-admin-tomcat5
Summary: Harvester Tomcat 5.5 integration
Requires: tomcat5 masterkey-harvester-admin-tomcat
Group: Applications/Internet

%package -n masterkey-harvester-tomcat5
Summary: Harvester Tomcat 5.5 integration
Requires: tomcat5 masterkey-harvester-tomcat
Group: Applications/Internet
...
%defattr(-,root,root)
%config %{_sysconfdir}/masterkey/harvester-admin/harvester-admin-context.xml
