...
/**
 * REST Web service (resource) that maps to a TranformationStepAssociation
 * entity.
 * 
 * @author Dennis
 */
public class TransformationStepAssociationResource {
  ...
  public TransformationStepAssociationConverter get() {
    return new TransformationStepAssociationConverter(dao.retrieveById(id),
  ...
  public void delete() {
    try {
      ...
      throw new WebApplicationException(WSUtils.buildError(500, "entity is in use"));
    }
  }
