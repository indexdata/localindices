...
public class TestFilterChain extends TestCase {
  ...
  String pz2solr = "<?xml version=\"1.0\"?>\n"
  ...
  String solrXml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
      ...
      + "    <arr name=\"typeOrientation\"><str>横</str></arr>\n" + "  </doc>\n" + "</result>\n"
      + "</response>\n" + "";
  String stylesheet2 = "<?xml version=\"1.0\"?>\n"
      + "<xsl:stylesheet version=\"1.0\" xmlns:xsl=\"http://www.w3.org/1999/XSL/Transform\" \n"
      + "                xmlns:pz=\"http://www.indexdata.com/pazpar2/1.0\" >\n" + "\n"
  ...
  private void doTest(String[] argv) {
    if (argv.length < 2) {
      System.err.println("Usage: java FilterChain xmlfile stylesheet1 [stylesheet2] ... ");
	...
	filter = stf
	    .newXMLFilter(new StreamSource(new ByteArrayInputStream(argv[index].getBytes())));
